 ...
 * @typedef {import ('../../types').RouteInterface} RouteInterface
 */

// import { Page } from '../../modules/page/page.module.js';

/**
 * The Router class is responsible for managing the application routes and navigation.
 * @typedef {Router}
 * @class Router
 */
class Router {
    ...
    _addItemToHistory(route) {
        if (route.url) {
            route.url = sanitizeURL(route.url);
        }
